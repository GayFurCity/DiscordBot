        ...
        try {
            ...
            if (err instanceof DiscordRESTError) {
                const messages: Record<number, string> = {
                    ...
                    [JSONErrorCodes.USER_BANNED]:       "You are either IP banned by discord (are you using a VPN?) or banned from the server. Server bans may be appealed by writing an email to admin@gayfur.city.",
